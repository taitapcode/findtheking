/**
 * Question bank for FindTheKing game
 * Global variable containing all questions
 */
window.QUESTIONS_DATA = [
  {
    "prompt": "Daniel Kahneman đã chỉ ra bộ não con người qua bao nhiêu hệ thống tư duy?",
    "options": ["1", "2", "3", "4"],
    "answerIndex": 1
  },
  {
  ...
  {
    "prompt": "Khi bạn tránh sang một bên ngay lập tức khi thấy xe máy lao tới, điều này thể hiện hoạt động của:",
    "options": ["Hệ thống 1", "Hệ thống 2"],
    "answerIndex": 0
  },
  {
    "prompt": "Nhận biết người đối diện đang vui vẻ chỉ qua nét mặt, điều này thể hiện hoạt động của:",
    "options": ["Hệ thống 1", "Hệ thống 2"],
    "answerIndex": 0
  },
  {
    "prompt": "Có ý thức, logic, chậm rãi và cần có sự tập trung cao là đặc điểm của hệ thống nào?",
    "options": ["Hệ thống 1", "Hệ thống 2"],
    "answerIndex": 1
  },
  {
  ...
  {
    "prompt": "Đối với các tình huống như xây dựng chiến lược, đầu tư, ký hợp đồng trong kinh doanh chúng nên áp dụng hệ thống nào?",
    "options": [
  ...
  {
    "prompt": "Có bao nhiêu bậc trong \"Tháp tư duy bậc thang\" (Bloom's taxonomy)?",
    "options": ["5", "6", "7", "8"],
    "answerIndex": 2
  },
  {
  ...
  {
    "prompt": "\"Tạo ra, lập kế hoạch, sản xuất\" là nhiệm vụ của bậc nào trong \"Tháp tư duy bậc thang\" (Bloom's taxonomy)?",
    "options": ["Phân tích", "sáng tạo", "hiểu", "đánh giá"],
    "answerIndex": 1
  },
  {
    "prompt": "\"Áp dụng\" là bậc thứ mấy trong \"Tháp tư duy bậc thang\" (Bloom's taxonomy)?",
    "options": ["1", "5", "3", "4"],
    "answerIndex": 2
  },
  {
  ...
  {
    "prompt": "Bạn thức dậy và nhận ra mình đã bỏ lỡ kỳ thi tiếng Anh đầu vào và không thể đặt lịch thi lại lần nữa. Bạn nên làm gì để giải quyết vấn đề này?",
    "options": [
